var Module = (function () {
  ...
  return function (Module) {
    ...
    var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 15728640;
    var wasmTable;
    var __ATPRERUN__ = [];
    var __ATINIT__ = [];
    var __ATPOSTRUN__ = [];
    ...
    var wasmBinaryFile;
    wasmBinaryFile = 'jupytercad.opencascade.wasm';
    ...
    var asmLibraryArg = {
      T: OSD_MemInfo_getModuleHeapLength,
      i: ___assert_fail,
      a: ___cxa_allocate_exception,
      V: ___cxa_thread_atexit,
      b: ___cxa_throw,
      F: ___sys_access,
      J: ___sys_chmod,
      n: ___sys_fcntl64,
    ...
    var _memalign = (Module['_memalign'] = function () {
      return (_memalign = Module['_memalign'] = Module['asm']['ka']).apply(
        null,
        arguments
      );
    });
